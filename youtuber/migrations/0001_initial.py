    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateTimeField(auto_now=True)),
                ('tag', taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
                ('youtubers', models.ManyToManyField(related_name='youtuber_list', to='youtuber.Youtuber')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('youtuber_list', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='youtuber.youtuberlist')),
            ],
        ),
        migrations.CreateModel(
            name='MyYoutuber',
